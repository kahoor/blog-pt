"""
Django settings for mainmotherfucker project.
...
SECRET_KEY = 'o05i+j*#3w(87r&(6!8t=(h842jq183)ckfto)tq+-ex-xwrso'
...
ROOT_URLCONF = 'mainmotherfucker.urls'
...
WSGI_APPLICATION = 'mainmotherfucker.wsgi.application'
